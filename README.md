Aplicacion de busqueda de paises, utiliza global context y utiliza dummyjson como API para el login, swr para el manejo del fetch y Router para el de rutas
